...
namespace Tesla.GFX
{
	...
	public class SkyBox
	{
		...
		{
			left 	= Texture.CreateFromFile(skyBoxPath + "/skyrender0001.bmp", TextureFilter.Nearest);
			front 	= Texture.CreateFromFile(skyBoxPath + "/skyrender0002.bmp", TextureFilter.Nearest);
			right 	= Texture.CreateFromFile(skyBoxPath + "/skyrender0004.bmp", TextureFilter.Nearest);
			back 	= Texture.CreateFromFile(skyBoxPath + "/skyrender0005.bmp", TextureFilter.Nearest);
			top		= Texture.CreateFromFile(skyBoxPath + "/skyrender0003.bmp", TextureFilter.Nearest);
		}
