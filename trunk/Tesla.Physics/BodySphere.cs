// BodySphere.cs created with MonoDevelop
// User: topfs at 1:38 PM 11/5/2008
//
...
namespace Tesla.Physics
{
	public class BodySphere
	{
		...
		public BodySphere(World hostWorld, Space space, Vector3f position, float radius, Vector3f force)
		{
			...
			Ode.dMassSetSphereTotal(ref mass, 200.0f, radius);
            ...
            geomID = Ode.dCreateSphere(space.getSpaceID(), radius);
